...
from InsaneMusic.misc import SUDOERS, pymongodb
...
from InsaneMusic.utils.decorators.language import language, languageCB
from InsaneMusic.utils.inline.stats import (
    back_stats_buttons,
    back_stats_markup,
    get_stats_markup,
    ...
    def get_stats():
        ...
        if what in ["Tracks", "Here"]:
            for items, count in list_arranged.items():
                ...
                if items == "telegram":
                    msg += f"🦋𝆺𝅥𓆩〭〬𝐂𖽪֟፝𖾓𖾝 ԍ𖽹𖾜֟፝𖾘 𝆺𝅥 𝐒𖽪𖽳𖽳𖽙𖽷𖾓😻⤍🖤  (https://t.me/cute_girl_support) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                else:
...
┗━━━━━━━━━━━━━━━━━⧫ 
 ...
 ╰💛 Cʟᴇᴀɴᴍᴏᴅᴇ ~ {cm} ᴍɪɴ
 ◆ Lɪᴍɪᴛs ~
 ╰🧨 Dᴜʀᴀᴛɪᴏɴ ʟɪᴍɪᴛ ~ {play_duration} ᴍɪɴ
 ╰🕯 Dᴏᴡɴʟᴏᴀᴅ ʟɪᴍɪᴛ ~ {song} ᴍɪɴ
 ╰🧸 Pʟᴀʏʟɪsᴛ ʟɪᴍɪᴛ ~ {playlist_limit}
 ╰🎓 Pʟᴀʏʟɪsᴛ ᴩʟᴀʏ ʟɪᴍɪᴛ ~ {fetch_playlist}
      •──────✦──────•
 Pᴏᴡᴇʀᴇᴅ ʙʏ 🦋𝆺𝅥𓆩〭〬𝐂𖽪֟፝𖾓𖾝 ԍ𖽹𖾜֟፝𖾘 𝆺𝅥😻⤍🖤
      •──────✦──────• """
